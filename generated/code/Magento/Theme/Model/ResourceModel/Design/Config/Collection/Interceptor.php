...
class Interceptor extends \Magento\Theme\Model\ResourceModel\Design\Config\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addScopeIdFilter');
        return $pluginInfo ? $this->___callPlugins('addScopeIdFilter', func_get_args(), $pluginInfo) : parent::addScopeIdFilter($scopeId);
    }
