...
class Interceptor extends \Magento\Catalog\Controller\Adminhtml\Category\Save implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function imagePreprocessing($data)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('imagePreprocessing', func_get_args(), $pluginInfo) : parent::imagePreprocessing($data);
    }
    ...
    public function stringToBoolConverting($data, $stringToBoolInputs = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('stringToBoolConverting', func_get_args(), $pluginInfo) : parent::stringToBoolConverting($data, $stringToBoolInputs);
    }
